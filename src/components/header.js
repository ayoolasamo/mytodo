    ...
    return (
        ...
        <div  className={` text-center  py-10 px-6 `}>
            <div className="grid grid-cols-2 py-4">
                <h1 className="text-start tracking-widest font-bold">TODO</h1>
                <div className=" grid place-items-end" >
                    <button id="theme-toggle" >
                        <svg id="theme-toggle-dark-icon" className="w-5 h-5 " xmlns="http://www.w3.org/2000/svg" width="26" height="26">
                        ...
                        <svg id="theme-toggle-light-icon" className="w-5 h-5 " xmlns="http://www.w3.org/2000/svg" width="26" height="26">
            ...
            <div className="py-2 item ">
                <input type="checkbox" className="rounded-full px-2" />
                <input className=" item " placeholder="hi">
                </input>
            </div>
        </div>
    )
